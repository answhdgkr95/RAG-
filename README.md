...
- **T-004**: RAG 기반 질의응답 시스템
  - ✅ 서브태스크 001: 검색 API 구현 완료
    - 백엔드 검색 엔드포인트 (`/api/search/`) 구현
    - 프론트엔드 API 연동 및 검색 UI 구현
    - Pydantic 스키마 정의 및 검증
    - API 테스트 성공 (헬스체크, 검색 기능)
  - 🔄 서브태스크 002: 문서 업로드 API 구현 (진행 예정)
  - ⏳ 서브태스크 003: 실제 RAG 로직 구현 (대기)
  - ⏳ 서브태스크 004: 벡터 DB 연동 (대기)
...
**📝 마지막 업데이트**: 2025-01-11 (T-004 서브태스크 001 완료 - 검색 API 구현)  
**🔄 다음 업데이트**: T-004 서브태스크 002 완료 시
